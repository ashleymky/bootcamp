...
public class DemoLambda {
  public static void main(String[] args) {
    ...
    Function<String, Integer> stringLengthFormula = (str) -> str.length(); // method implementatioin
    System.out.println(stringLengthFormula.apply("hello")); // 5 , after execution

    // ! Beofre Java8,  classic way to define class, and use method
    ...
    // for-each
    List<Dog> dogs =
        new ArrayList<>(Arrays.asList(new Dog("John", 10), new Dog("Peter", 4)));
    for (Dog d : dogs) {  // classic for loop
    ...
    System.out.println(getDogNameFunction.apply(new Dog("Rodoff", 10))); // Rodoff
