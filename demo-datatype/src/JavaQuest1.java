 ...
 * true The variable fnumber is -130.2 The variable dnumber is -20.5 The variable remainder is 1 The variable result is 3
 */
...
public class JavaQuest1 {
  ...
  public static void main(String[] args) {
    ...
    int result = e - (o * x) / y;
    System.out.println("The varialble result is " + result);
  }
}
