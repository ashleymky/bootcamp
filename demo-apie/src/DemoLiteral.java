public class DemoLiteral {
  // ! Literal Pool -> String
  // ! Internal Cache -> Integer, Byte, Short, Long, Boolean, Character (Xfloat, double)

  public static void main(String[] args) {
    String s1 = "hello";
    String s2 = "hello";
    String s3 = "olleh";
    System.out.println(s1.equals(s2)); // true, String Author determine the definition of equals()
